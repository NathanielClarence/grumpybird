function flyingEnemyBox(x1,x2,y1,y2, color){
    ...
    this.image.src = "monster-stage-3.png"
    this.vx = 0;
    this.vy = 0;
    this.xstart = 0;
    this.ystart = 0;
    }
    flyingEnemyBox.prototype.draw=function(context){
    context.save();
    ...
    flyingEnemyBox.prototype.randomColor=function(){
