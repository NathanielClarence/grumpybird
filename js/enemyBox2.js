function enemyBox2(x1,x2,y1,y2, color){
    ...
    this.image.src = "monster-stage-2.png"
    this.vx = 0;
    this.vy = 0;
    this.xstart = 0;
    this.ystart = 0;
    }
    enemyBox2.prototype.draw=function(context){
    context.save();
    ...
    enemyBox2.prototype.randomColor=function(){
